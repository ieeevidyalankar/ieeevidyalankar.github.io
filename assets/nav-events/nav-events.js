...
//         const slides = document.querySelectorAll('.slide');
//         const carouselDots = document.querySelectorAll('.dot');  // Renamed 'dots' to 'carouselDots'
//         const totalSlides = slides.length;
...
//             // Remove 'active-slide' class from all slides and 'active' from all dots
//             slides.forEach(slide => slide.classList.remove('active-slide'));
//             carouselDots.forEach(dot => dot.classList.remove('active'));  // Updated variable name

//             // Add 'active-slide' to the current slide and 'active' to the current dot
//             slides[currentIndex].classList.add('active-slide');
//             carouselDots[currentIndex].classList.add('active');  // Updated variable name
//         }
